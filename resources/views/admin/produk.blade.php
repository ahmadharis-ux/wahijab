...
<div class="container">
    ...
    <div class="container py-5">
        <div class="col d-flex justify-content-end mb-2">
            <a href="/admin/produk/create" class="btn btn-sm btn-success">Tambah Produk +</a>
        </div>
        <div class="row">

            <div class="col-lg-3">
                <h1 class="h2 pb-4">Categories <button class="btn btn-sm btn-success"  data-bs-toggle="modal" data-bs-target="#exampleModal">+</button></h1>
                    {{-- Modal Create kategori --}}
                    @include('admin.produk.modalCreateKategori')
                            ...
                            <div class="card rounded-0">
                                ...
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white mt-2" href="/admin/produk/single/{{$ListProduk->id}}"><i class="fa fa-pen"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-body">
