        ...
        <div class="container pb-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">{{$DataProduk->name}}</h1>
                            <p class="h3 py-2">Rp. {{number_format($DataProduk->harga)}}</p>

                            <h6>Deskripsi:</h6>
                            <p>{{$DataProduk->deskripsi}}Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod temp incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse. Donec condimentum elementum convallis. Nunc sed orci a diam ultrices aliquet interdum quis nulla.</p>
                            <div class="row pb-3">
                                <div class="col d-grid">
                                    <button type="submit" class="btn btn-success btn-lg" data-bs-toggle="modal" data-bs-target="#modalBeli">Buy</button>
                                    {{-- Modal Beli --}}
                                    @include('user.single_shop.modalBeliProducts')
                                    {{-- end Modal Beli --}}
                                </div>
                                <div class="col d-grid">
